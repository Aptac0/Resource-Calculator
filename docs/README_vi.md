...
- Đảm bảo ảnh chụp màn hình rõ ràng
- Các con số phải có thể nhìn thấy
- Hãy thử chụp ảnh màn hình khác rõ ràng hơn

### "Lỗi cập nhật"
- Kiểm tra kết nối Internet của bạn
- Thử lại trong vài phút
- Nếu vẫn tiếp diễn, hãy khởi động lại ứng dụng

### Các hình ảnh không được xử lý
- Xác minh bạn đã chọn vương quốc
- Kiểm tra xem các số có hợp lệ không
- Đảm bảo bạn có đủ hình ảnh
...
- Tesseract OCR (được bao gồm trong trình cài đặt)

## 🔐 Quyền Riêng Tư

Ứng dụng:
- ✅ Hoạt động hoàn toàn ngoại tuyến
- ✅ Không bao giờ gửi hình ảnh của bạn đến bất kỳ máy chủ nào
- ✅ Không cần đăng ký hoặc tài khoản
- ✅ Dữ liệu của bạn vẫn nằm trên máy tính của bạn
