...
- Pastikan tangkapan layar jelas dan dapat dibaca
- Angka harus terlihat
- Coba ambil tangkapan layar lain yang lebih jelas

### "Kesalahan pembaruan"
- Periksa koneksi Internet Anda
- Coba lagi dalam beberapa menit
- Jika berlanjut, mulai ulang aplikasi

### Gambar tidak diproses
- Verifikasi Anda telah memilih kerajaan
- Periksa bahwa angka valid
- Pastikan Anda memiliki cukup gambar
...
- Tesseract OCR (disertakan dalam penginstal)

## 🔐 Privasi

Aplikasi:
- ✅ Berfungsi sepenuhnya offline
- ✅ Tidak pernah mengirim gambar Anda ke server mana pun
- ✅ Tidak memerlukan pendaftaran atau akun
- ✅ Data Anda tetap ada di komputer Anda
