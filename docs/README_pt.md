...
- Certifique-se que a captura de tela seja clara
- Os números devem estar visíveis
- Tente tirar outra captura mais clara

### "Erro de atualização"
- Verifique sua conexão com a Internet
- Tente novamente em poucos minutos
- Se persistir, reinicie o aplicativo

### As imagens não estão sendo processadas
- Verifique se você selecionou um reino
- Verifique se os números são válidos
- Certifique-se que você tem imagens suficientes
...
- Tesseract OCR (incluído no instalador)

## 🔐 Privacidade

O aplicativo:
- ✅ Funciona completamente offline
- ✅ Nunca envia suas imagens para nenhum servidor
- ✅ Sem registro ou conta necessária
